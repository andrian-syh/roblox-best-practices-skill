...
- [ ] In review mode: each finding triaged as Blocker/Correctness/Advisory and run through the false-positives gate; Advisory items proposed not forced; unrelated code untouched. For whole-system health evaluations or maturity audits, score against [evaluation-matrix.md](evaluation-matrix.md)
